...
const Suspending = () => {
  ...
  const { setData } = useData()
    ...
    const { refetch: refetchSuspend, loading: loadingSuspend, data: dataSuspend } = useGet({ url: 'https://marfaa-alex.com/api/admin/users'});
    ...
    useEffect(() => {
      if(dataSuspend){
        setSuspend(dataSuspend.suspended)
      }
      console.log("data Accept" , dataSuspend)
    }, [dataSuspend])
